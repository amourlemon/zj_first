function toUpperTools(str) {
    const newStr = str.toUpperCase();
    console.log(newStr);
}

toUpperTools('Emerging Topics in Computational Intelligence')

function compareFn(str1, str2) {
    const res = (str1 === str2);
    console.log(res);
}

compareFn(`Abstract—The click-through conversion rate prediction has always been an important direction of the e-commerce platform. This
